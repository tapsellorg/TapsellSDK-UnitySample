...
@interface TapsellUnityController : TapsellPlatformsController
...
-(void) onAdAvailable:(TapsellAd* )ad;
-(void) onNoAdAvailable:(NSString* )zoneId;
-(void) onError:(NSString* )error zoneId:(NSString* )zoneId;
...
+ (TapsellUnityController*) sharedInstance {
    ...
    dispatch_once(&onceToken, ^{ 
        ...
        [[TapsellExtraPlatformsController sharedInstance] setPlatformController:instance];
