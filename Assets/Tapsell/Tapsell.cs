...
namespace TapsellSDK
{
    ...
    public class Tapsell
    {
        ...
        /// <summary>
        /// Sets the permission handler config.
		/// Passed parameter must be one of PERMISSION_HANDLER_DISABLED, PERMISSION_HANDLER_AUTO and PERMISSION_HANDLER_AUTO_INSIST
        /// </summary>
        ...
        public static void requestNativeBannerAd(
			...
			string zoneId, Action<TapsellNativeBannerAd> onRequestFilled,
			Action<string> onNoAdAvailableAction,
            Action<TapsellError> onErrorAction,
			Action<string> onNoNetworkAction)
        {
